...
var DsaFactory = require('../codes/stack-eval/lined');
...
Demo.prototype.others = function () {
  return this._descriptions.others;
}
...
Demo.prototype.run = function (cmd, param) {
  ...
  this._descriptions = DsaFactory.eval(param);
  // this._breakpoints = DsaFactory.getBreakpoints();
  this._breakpoints = this._descriptions.frames;
